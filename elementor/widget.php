...
class c2cb_WhatsApp_Widget extends Widget_Base {
    public function get_name() {
        return 'c2cb_whatsapp_chat';
    }

    public function get_title() {
        return __('WhatsApp Chat Button', 'c2cb');
    }
    ...
    protected function render() {
        if (get_option('c2cb_enable_button') != '1') return;

        $start = get_option('c2cb_business_hours_start', '09:00');
        $end = get_option('c2cb_business_hours_end', '18:00');
        ...
        $mobile_only = get_option('c2cb_mobile_only') === '1';
        ...
        echo '<a class="c2cb-elementor-button" href="https://wa.me/' . esc_attr($number) . '?text=' . esc_attr($message) . '" 
                 target="_blank"
